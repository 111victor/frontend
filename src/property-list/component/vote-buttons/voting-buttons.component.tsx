...
import { PropertyDescription, PropertyDetails } from '../../interfaces/property-description.interface';

const VotingButtonsComponent = ({propertyDetail}: {
    ...
    return (
        <div className="voting-buttons">
            <button className="upvote-button" onClick={() => handleUpdateVote(propertyDetail.id, actionTypes.upvote)}>
                <i className="fa fa-arrow-up"></i>
            </button>
            <span>
                {votes.upvote}
            </span>
            <button className="downvote-button" onClick={() => handleUpdateVote(propertyDetail.id, actionTypes.downvote)}>
